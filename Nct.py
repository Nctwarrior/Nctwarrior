...
#
#input('David Vau Will Started Now')
import os
try:
  import requests
except ImportError:
...
\033[1;92m  ____  _     _ _     _
\033[1;92m |  \/  |  _ __  | | | | ___   __ _ _   _  ___
\033[1;92m | |\/| | | '__| | |_| |/ _ \ / _` | | | |/ _ \
\033[1;92m | |  | |_| |    |  _  | (_) | (_| | |_| |  __/
\033[1;92m |_|  |_(_)_|    |_| |_|\___/ \__, |\__,_|\___|
print ''
print '-' *50
print ''
...
def login():
  ...
  try:
    ...
    logo()
    print(" [*] National Cyber Team Let The War Begin")
